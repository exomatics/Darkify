...
export class TrackService {
   ...
   * @throws ApiError
   */
  public postTracks(formData?: PostTrackRequest): CancelablePromise<TrackInfo> {
   ...
   * @throws ApiError
   */
  public getTracks(trackId: string): CancelablePromise<TrackInfo> {
    return this.httpRequest.request({
      method: 'GET',
      url: '/tracks/{trackId}',
      path: {
   ...
   * @throws ApiError
   */
  public putTracks(trackId: string, formData: PutTrackRequest): CancelablePromise<TrackInfo> {
    return this.httpRequest.request({
      method: 'PUT',
      url: '/tracks/{trackId}',
      path: {
   ...
   * @throws ApiError
   */
  public getTracksSearch(trackName: string): CancelablePromise<{
    total?: number;
    offset?: number;
    next?: number | null;
   ...
   * @throws ApiError
   */
  public getTracksStream(trackId: string): CancelablePromise<Blob> {
    return this.httpRequest.request({
      method: 'GET',
